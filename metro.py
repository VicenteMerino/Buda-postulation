class Metro:
    ...
    def solve_shortest_route(self, bus, origin, end):
        ...
        if (
            ...
            self.colors[end_index] == "red"
            and self.colors[origin_index] == "green"
        ):
            return (
                False,
                f"origin and end stations of different color ({self.colors[origin_index]} & {self.colors[end_index]})",
                None,
            )
        if (
            bus
            ...
            return (
                False,
                f"the origin station and the bus has different colors ({self.colors[origin_index]} & {bus})",
                None,
            )
        if bus and self.colors[end_index] and bus != self.colors[end_index]:
            return (
                False,
                f"the end station and the bus has different colors ({self.colors[end_index]} & {bus})",
                None,
            )
